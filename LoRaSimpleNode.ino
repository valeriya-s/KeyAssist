...
SoftwareSerial ss(PC5, PC4);

const long frequency = 915E6;  // LoRa Frequency

const int csPin = PB0;  //SCK!!       // LoRa radio chip select
const int resetPin = PB6;        // LoRa radio reset
const int irqPin = PB15; // DIO0          // change for your board; must be a hardware interrupt pin
const int Button1 = PB2;
const int Button2 = PB3; // CHANGE!!!
const int RedLight = PC13;
const int BlueLight = PB10;
const int YellowLight = PC6;
